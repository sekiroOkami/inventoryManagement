...
import org.sekiro.InventoryManagementSystem.dto.TransactionDTO;
...
import org.sekiro.InventoryManagementSystem.entities.Transaction;
...
import org.sekiro.InventoryManagementSystem.exceptions.NameValueRequiredException;
...
import org.sekiro.InventoryManagementSystem.repository.TransactionRepository;
...
public class TransactionServiceImpl implements TransactionService {
    ...
    public Response returnToSupplier(TransactionRequest transactionRequest) {
        ...
        if (supplierId == null) throw new NameValueRequiredException("SupplierId Required.");
    ...
    public Response getAllTransactions(int page, int size, String searchText) {
        ...
        List<TransactionDTO> transactionDTOS =
                modelMapper.map(transactionPage.getContent(), new TypeToken<List<TransactionDTO>>(){}.getType());
